...
dependencies {
    ...
    implementation("androidx.camera:camera-camera2:1.4.0-alpha01") // CameraX Core library
    implementation("androidx.camera:camera-lifecycle:1.4.0-alpha01") // CameraX Lifecycle library
